...
export function AdvanceWorkspace() {
    ...
    const handleGenerateReadme = async () => {
        ...
        try {
            ...
            // Using the README generator API running on port 8000
            const res = await axios.post(`http://localhost:8000/api/v1/readme/auto/raw`, payload, {
                responseType: 'text'
            });
            ...
            alert(`Error generating README: ${detail}\nMake sure the README generator backend is running on port 8000.`);
        } finally {
